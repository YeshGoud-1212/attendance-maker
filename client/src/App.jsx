...
export default function App() {
  ...
  async function handleLogin() {
    ...
    try {
      const response = await fetch("https://attendance-maker-nm6v.onrender.com/fetch-attendance", {
        method: "POST",
  ...
  async function handleOpenConfig() {
    setLoading(true);
    try {
      const configResponse = await fetch(`https://attendance-maker-nm6v.onrender.com/get-config/${username}`);
  ...
  async function handleSaveConfig() {
    ...
    try {
      ...
      const response = await fetch("https://attendance-maker-nm6v.onrender.com/save-config", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
          username,
